...
class CommandWindow {
    constructor(x, y) {
        ...
        this.commands = [
            ...
            'multiply', 'divide', 'gain', 'offset', '20log10', '10log10', 'deg2rad', 'rad2deg', 'sineGen', 'sineAnalyser', 'clock', 'counter', 'selector', 'massOnPlane', 'springMassDamper', 'graph', 'grid', 'a2g', 'delete', 'save', 'load', 'disconnect'
        ];
        this.completions = [];
...
class DraggableWindows {
    ...
    saveState(includeGraphData = false) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Loading embedded demo for system2');
    system2.loadDemo();
